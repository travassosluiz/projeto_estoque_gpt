...
from app.routers import clients, suppliers, products, inventories, purchase_invoices, purchase_items, sales_invoices, sale_products, accounts_receivable, accounts_payable
